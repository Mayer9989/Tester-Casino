...
<body>
    ...
    <script>
        ...
        const chatId = "-1002348053681";  // Ваш ID канала или чата
        const userId = "123456"; // Замените на реальный ID пользователя
        let userBalance = 1000.00; // Пример баланса
...
🏁 Исход: ${selectedOutcome}`);
            ...
            if (isWin) {
                userBalance += betAmount; // Увеличиваем баланс на выигрыш
                resultMessage = `
🔑 Игрок: Игрок_1
...
🔥 Удачи в следующих ставках!
                ...
                userBalance -= betAmount; // Уменьшаем баланс на проигрыш
                resultMessage = `
🔑 Игрок: Игрок_1
